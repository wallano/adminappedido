...
<body>
    ...
    <div class="page-title">Mis Compras</div>
 
    <c:if test="${empty cartForm or empty cartForm.cartLines}">
        <h2>No hay ítems en la compra</h2>
    ...
    <c:if test="${not empty cartForm and not empty cartForm.cartLines   }">
        <form:form method="POST" modelAttribute="cartForm"
            ...
            <c:forEach items="${cartForm.cartLines}" var="cartLineInfo"
                ...
                <div class="product-preview-container">
                    <ul>
                        ...
                        <li>Código: ${cartLineInfo.productInfo.code} <form:hidden
            ...
            <input class="button-update-sc" type="submit" value="Actualizar Cantidad" />
            <a class="navi-item"
                href="${pageContext.request.contextPath}/shoppingCartCustomer">Ingrese Información del Cliente</a>
            <a class="navi-item"
                href="${pageContext.request.contextPath}/productList">Continuar la Compra
                </a>
        </form:form>
